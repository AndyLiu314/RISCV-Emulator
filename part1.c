...
void print_jal(Instruction instruction) {
    int signed_imm = get_jump_offset(instruction);
    printf(JAL_FORMAT, instruction.ujtype.rd, signed_imm); 
}
...
void print_store(char *name, Instruction instruction) {
    int signed_imm = get_store_offset(instruction);
    printf(MEM_FORMAT, name, instruction.stype.rs2, signed_imm, instruction.stype.rs1);

}

//this works
void print_branch(char *name, Instruction instruction) {
    int signed_imm = get_branch_offset(instruction);
    printf(BRANCH_FORMAT, name, instruction.sbtype.rs1, instruction.sbtype.rs2, signed_imm);
}
